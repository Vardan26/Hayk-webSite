$(document).ready(function () {
    ...
    for(i=0; i<$(".brandQuantity__input").val(); i++) {
        $('.brandQuantity__bottles').append('<img src="img/bottleOrder.png" />');
    }
    $(".brandQuantity__bottles img:first-child").addClass("active__bottle");
    $('.brandQuantity__btn').on('click',function(){
        $('.brandQuantity__bottles').empty();  //Remove all child nodes
        var value = $(".brandQuantity__input").val();
        for(i=0; i<parseInt(value); i++) {
            $('.brandQuantity__bottles').append('<img src="img/bottleOrder.png" />');
        }
        $('.brandQuantity__bottles img').click(function() {
            $('.brandQuantity__bottles img').click(function(event){
                $('.active__bottle').removeClass('active__bottle');
                $(this).addClass('active__bottle');
